...
Item {
    ...
    ClickableTextBox {
        ...
        NumberAnimation on pointSize {id: text3Animation; from: 1; to: centerCircleTextHeight}
    ...
    ClickableTextBox {
        ...
        horizontalAlignment: Text.AlignHCenter
        verticalAlignment: Text.AlignVCenter
        NumberAnimation on pointSize {id: text4Animation; from: 1; to: centerCircleTextHeight}
    ...
    ClickableTextBox {
        ...
        horizontalAlignment: Text.AlignHCenter
        verticalAlignment: Text.AlignVCenter
        NumberAnimation on pointSize {id: text5Animation; from: 1; to: centerCircleTextHeight}
